const Login = () => {
    return (
      <div
        ...
        style={{
          backgroundImage:
            'url("https://ds.static.rtbf.be/article/image/770x433/1/9/0/6e0917469214d8fbd8c517dcdc6b8dcf-1630402493.jpg")',
      ...
      >
        <form className="bg-opacity-10 backdrop-blur-lg p-8 rounded-xl border bg-purple-900 max-w-sm w-full">
          ...
          <button className="text-white p-3 rounded-md w-full bg-purple-700">
            Sign In
          </button>
          
          <span className="flex text-white font-bold justify-center mt-5">
            ou continue avec
          </span>
